...
🔗 [View on GitHub Pages](https://sinaprj-web.github.io/Simple-Todo-App/](https://sinaprj-web.github.io/Simple-Todo-App/))
...
- 💾 Saves tasks locally in your browser  
...
```bash
# clone the repo
git clone https://github.com/SinaPrj-web/Simple-Todo-App.git
